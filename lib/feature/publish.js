...
async function init (args) {
  ...
  try {
    await git.checkout(selectedBranche)
    await git.push('origin', selectedBranche)
  } catch (e) {
  ...
  log('success', `Branche ${selectedBranche} published correctly`)
  log('success', `Now you can publish it with feature finish command to merge into develop branche`)
}
